...
def policy_figure(env_name: str, pred_probs_s: Float[Array, "horizon num_actions"], title: str) -> Figure:
...
def visualize_env_state_frame(env_name: str, env_state: PyTree[Array], **kwargs) -> Float[Array, " channel height width"]:
